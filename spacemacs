...
you should place your code here." 
  ...
  (setq org-ref-default-bibliography '("~/MasterDegree/references.bib")
        org-ref-pdf-directory "~/MasterDegree/"
        org-ref-bibliography-notes "~/MasterDegree/notes.org")
  )
